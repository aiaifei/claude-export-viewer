...
即使账号因异常活动被冻结（提示 **Your account is on hold**），你的聊天记录和数据依然安全保存着，也仍然可以导出。

重新打开 Claude.ai 登录后会跳转到这个封号提示页面，在 **What you can do** 区域点击 **Export your data**，即可打包下载你的全部对话、项目和设置（同样通过邮件链接下载）。

![被封号后导出数据](docs/images/export-onhold.jpg)

> 💡 正因如此，**平时养成定期备份的习惯非常重要**——封号后再导出虽然可行，但事先有备份会让你更安心。
